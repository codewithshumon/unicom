...
import { stepsBlob4 } from "../../assets/images";
import { OutLinkArrow } from "../global";

const StepModalEnergyBills = ({ handleCount, handleCountBack }) => {
    ...
    <div className="w-full h-full flex items-center justify-center">
      <div className="w-[40vw] h-full landing-bg relative ">
        <div className="absolute w-full h-full px-[10%] flex items-end justify-center">
          <div className="w-full h-[80vh] flex flex-col items-start justify-between pb-[5vh]">
            <div>
              <h1 className="w-[60%] font-[600] text-[#282866] text-[3vw] leading-none">
                Helping You Reduce Energy Bills
              </h1>
            </div>
            <div className="w-full">
              <div className=" w-full text-[#282866] text-[2vh] font-[600] flex items-center justify-between cursor-pointer ">
                ...
                <span className="text-[#4E4EFF]">Reduce Energy Bills</span>
        ...
        <div className="w-full h-full flex items-end justify-start">
          <img src={stepsBlob4} className="h-[80vh]" />
        </div>
      </div>

      <div className="w-[60vw] h-full bg-white relative flex justify-center items-end">
        <div className="w-[60%] h-[80vh] pb-[5vh] text-[#282866] flex flex-col items-start justify-between gap-[2vh]">
          <div className="w-full">
            <form className="flex flex-col gap-[1vh] font-[600] text-[1vw] text-[#282866] ">
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>
                      Have you accessed any energy <br /> rebates in the past
                      year?
                    </p>
                  </div>
              ...
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>Do you want to save on your lighting bill?</p>
                  </div>
                  <div className="flex gap-[2vw]">
                    <div>
                      <label
              ...
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>
                      Do you have an electric to <br /> electric hot water
                      system?
                    </p>
                  </div>
                  <div className="flex gap-[2vw]">
              ...
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>Is the hot water system over 10 years old?</p>
                  </div>
                  <div className="flex gap-[2vw]">
                    <div>
                      <label
                      ...
                      <input
                        ...
                        value="yes"
                        onChange={handleInputChange}
                        checked={formData.questionFour === "yes"}
                      />
                    </div>
                    <div>
                      <label
                      ...
                      <input
                        ...
                        value="no"
                        onChange={handleInputChange}
                        checked={formData.questionFour === "no"}
                      />
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>
                      Do you have a commercial building <br /> that could use
                      solar power?
                    </p>
                  </div>
                  <div className="flex gap-[2vw]">
                    <div>
                      ...
                      <input
                        ...
                        value="yes"
                        onChange={handleInputChange}
                        checked={formData.questionFive === "yes"}
                      />
                    </div>
                    <div>
                      <label
                      ...
                      <input
                        ...
                        value="no"
                        onChange={handleInputChange}
                        checked={formData.questionFive === "no"}
                      />
                    </div>
                  </div>
                </div>
...
export default StepModalEnergyBills;
