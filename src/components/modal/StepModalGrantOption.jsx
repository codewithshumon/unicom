...
import { stepsBlob3 } from "../../assets/images";
import { OutLinkArrow } from "../global";

const StepModalGrantOption = ({ handleCount, handleCountBack }) => {
    ...
    <div className="w-full h-full flex items-center justify-center">
      <div className="w-[40vw] h-full landing-bg relative ">
          ...
          <div className="w-full h-[72vh] flex flex-col items-start justify-between pb-[5vh]">
            <div>
              <h1 className="w-[60%] font-[600] text-[#282866] text-[3vw] leading-none">
                Helping You Find Grant Options.
              </h1>
            </div>
            <div className="w-full">
              <div className=" w-full text-[#282866] text-[2vh] font-[600] flex items-center justify-between cursor-pointer ">
                ...
                <span className="text-[#4E4EFF]">Grant Options</span>
        ...
        <div className="w-full h-full flex items-end justify-start">
          <img src={stepsBlob3} className="h-[80vh]" />
        </div>
      </div>
            ...
            <form className="flex flex-col gap-[1vh] font-[600] text-[1vw] text-[#282866] ">
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>
                      Have you accessed any government <br /> grants in the past
                      year?
                    </p>
                  </div>
              ...
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>
                      Are you working on a research <br /> and development
                      project?
                    </p>
                  </div>
                  <div className="flex gap-[2vw]">
              ...
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>Do you do any international business?</p>
                  </div>
                  <div className="flex gap-[2vw]">
                    <div>
                      <label
              ...
              <div>
                <div className="rounded-[1vw] bg-white p-[2vh] flex items-center justify-between">
                  <div>
                    <p>
                      Are you a charity, NDIS provideror <br /> healthcare
                      provider?
                    </p>
                  </div>
                  <div className="flex gap-[2vw]">
...
export default StepModalGrantOption;
