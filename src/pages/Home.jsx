  ...
  return (
    <>
      <div className="">
        ...
        <section className="w-full h-full landing-bg overflow-x-hidden">
          <div className="w-full h-full relative">
            <div className=" absolute px-[5%] py-[5%] h-full flex flex-col justify-between gap-5 z-10">
              <div>
              ...
              <div className=" absolute left-[45vw] top-[98vh]">
